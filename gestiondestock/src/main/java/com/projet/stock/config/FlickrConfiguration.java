...
public class FlickrConfiguration {
  ...
  private String appSecret;
	...
	/*
	 * @Bean public Flickr getFlickr() throws InterruptedException,
	 * ExecutionException, IOException, FlickrException { Flickr flickr = new
	 * Flickr(apiKey, apiSecret, new REST()); OAuth10aService service = new
	 * ServiceBuilder(apiKey).apiSecret(apiSecret).build(FlickrApi.instance(
	 * FlickrPerm.WRITE));
	 * 
